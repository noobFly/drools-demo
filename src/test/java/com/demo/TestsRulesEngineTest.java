...
public class TestsRulesEngineTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		// Ideally, this would be set only once as a JVM property for your
		// program
	...
	private class MachineResultSetImpl implements MachineResultSet {
		...
		public MachineResultSetImpl() {
			...
			m1.setVmap(vmap);
			m1.setType("Type1");
			m1.setFunctions(Arrays.asList(new String[] { "DDNS Server", "DNS Server" }));
			Machine m2 = new Machine();
			m2.setSerialNumber("1234B");
			m2.setType("Type2");
			m2.setFunctions(Arrays.asList(new String[] { "DDNS Server", "DNS Server" }));
			Machine m3 = new Machine();
			m3.setSerialNumber("1234C");
			m3.setType("Type2");
			m3.setFunctions(Arrays.asList(new String[] { "Gateway", "Router" }));
			...
			machines = Arrays.asList(new Object[] { m1, m2, m3, m4, m5 }).iterator();
		}
